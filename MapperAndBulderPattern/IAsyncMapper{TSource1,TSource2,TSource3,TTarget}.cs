namespace MapperAndBulderPattern
{
    ...
    public interface IAsyncMapper<in TSource1, in TSource2, in TSource3, in TTarget>
        ...
        where TTarget : class
    {
        ...
        Task MapAsync(TSource1 source1, TSource2 source2, TSource3 source3, TTarget target, CancellationToken cancellationToken = default);
    }
}
